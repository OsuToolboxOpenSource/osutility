...
namespace OsuModel.BeatMapFile
{
    ...
    public class BeatMapSet
    {
        ...
        BeatMapSet(string path) { Load(path); }
        /// <summary>
        /// 读取指定的路径
        /// </summary>
        /// <param name="path">BeatMapSet所在路径</param>
    ...
    public class OSUFile
    {
        ...
        /// 整个BeatMap的信息
        /// </summary>
        public OsuModel.BeatMapInfo.SongInfo SongInfo { get; set; }
        /// <summary>
        /// osu文件内嵌SB的信息
        /// </summary>
        public OsuModel.BeatMapInfo.StoryBoard SBInfo { get; set; }
        /// <summary>
        /// 默认构造函数
        /// </summary>
        public OSUFile() { }
        ...
        public OSUFile(BeatMapSet BMS, string path) { Load(BMS, path); }
        /// <summary>
    ...
    public class OSBFile
    {
        ...
        /// 存储在osb文件里的SB信息
        /// </summary>
        public OsuModel.BeatMapInfo.StoryBoard SBInfo;
        /// <summary>
        /// 默认构造函数
        /// </summary>
        public OSBFile() { }
